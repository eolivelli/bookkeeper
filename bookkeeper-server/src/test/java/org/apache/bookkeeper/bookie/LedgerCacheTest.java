...
public class LedgerCacheTest {
    ...
    public void testIndexPageEvictionWriteOrder() throws Exception {
        ...
        for (int i = 1; i <= numLedgers; i++) {
            ...
            b.addEntry(packet, new Bookie.NopWriteCallback(), null, "passwd".getBytes(), BookieProtocol.LEDGERTYPE_PD_JOURNAL);
        }
    ...
    public void testEntryMemTableFlushFailure() throws Exception {
        ...
        bookie.addEntry(generateEntry(1, 1), new Bookie.NopWriteCallback(), null, "passwd".getBytes(), BookieProtocol.LEDGERTYPE_PD_JOURNAL);
