...
public class Bookie extends BookieCriticalThread {
     ...
     */
    public void addEntry(ByteBuf entry, WriteCallback cb, Object ctx, byte[] masterKey, short ledgerType)
    ...
    public static void main(String[] args)
        ...
        for (int i = 0; i < 100000; i++) {
            ...
            buff.writeLong(i);
            cb.incCount();
            b.addEntry(buff, cb, null, new byte[0], BookieProtocol.LEDGERTYPE_PD_JOURNAL);
        }
        cb.waitZero();
